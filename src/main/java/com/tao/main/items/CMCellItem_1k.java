...
public class CMCellItem_1k extends Item implements CMBaseCellItem {
    private final CMCellTiers tier = CMCellTiers.TIER_1;
    public CMCellItem_1k(Properties properties) {
        super(properties);
    }
    @Override
