...
public class CMCellItem_16k extends Item implements CMBaseCellItem {
    private final CMCellTiers tier = CMCellTiers.TIER_3;
    public CMCellItem_16k(Properties properties) {
        super(properties);
    }
    @Override
