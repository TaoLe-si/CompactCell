...
public class CMCellItem_4k extends Item implements CMBaseCellItem {
    private final CMCellTiers tier = CMCellTiers.TIER_2;
    public CMCellItem_4k(Properties properties) {
        super(properties);
    }
    @Override
