...
public class CMCellItem_64k extends Item implements CMBaseCellItem {
    private final CMCellTiers tier = CMCellTiers.TIER_4;
    public CMCellItem_64k(Properties properties) {
        super(properties);
    }
    @Override
